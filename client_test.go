...
func TestUserAgentHeader(t *testing.T) {
	...
	client.URLs.New(context.Background(), ssturlshortener.URLNewParams{
		OriginalURL: ssturlshortener.F("REPLACE_ME"),
	})
	if userAgent != fmt.Sprintf("SstURLShortener/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.URLs.New(context.Background(), ssturlshortener.URLNewParams{
		OriginalURL: ssturlshortener.F("REPLACE_ME"),
	})
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.URLs.New(cancelCtx, ssturlshortener.URLNewParams{
		OriginalURL: ssturlshortener.F("REPLACE_ME"),
	})
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.URLs.New(deadlineCtx, ssturlshortener.URLNewParams{
			OriginalURL: ssturlshortener.F("REPLACE_ME"),
		})
		if err == nil || res != nil {
